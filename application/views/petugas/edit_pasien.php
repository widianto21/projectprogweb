		...
		<div class="input_table">
			...
			<form action="<?php echo base_url(). 'petugas/update'; ?>" method="post">	
				...
				<tr>
					...
					<td><input type="text" name="txtnamaibu" value = "<?php echo $u->NAMA_IBU_KANDUNG ?>" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="radio" name="kwn" value="Indonesia" <?php echo ($u->KEWARGANEGARAAN=='Indonesia')?'checked':''?>>Indonesia</input>
						<input type="radio" name="kwn" value="Asing" <?php echo ($u->KEWARGANEGARAAN=='Asing')?'checked':''?>>Asing</input>
					</td>
				</tr>
				<tr>
