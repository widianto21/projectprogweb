	...
	<form method="post" id="form_input" action="<?php echo base_url();?>admin/input_data_dokter?>">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="txtNoTelp" value="<?php echo set_value('txtNoTelp');?>"/><?php echo form_error('txtNoTelp');?></td>
			</tr>
			<tr>
				<td class="title"><label>Alamat</label></td>
				<td><textarea name="txtAlamat" cols="40" value="<?php echo set_value('txtAlamat');?>"></textarea><?php echo form_error('txtAlamat');?></td>
			</tr>
			<tr>
